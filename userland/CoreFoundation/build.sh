...
OBJS=()
for f in CFRuntime CFAllocator CFNull CFBoolean CFString CFArray CFDictionary CFSet CFNumber CFData CFDate CFTimeZone CFLocale CFURL CFPropertyList; do
